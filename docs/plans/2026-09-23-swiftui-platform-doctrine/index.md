...
| U4 | 3    | [04-docs.md](04-docs.md)                     | edit | `site/src/content/docs/**`, `.claude/skills/stackgen-plugin/**`, `.claude/docs/**`, `readme.md`, `CLAUDE.md`, `plugins/stackgen/stacks/readme.md`, `docs/memory/decisions/2026-09-23-swift-native-stack.md`                                                  | U3         | green   |          |
...
| 3    | U4         | opus  | 2     | green       | decision doc 2d link → archived/ path (resolves once the landing archives); E16 rejected list restored                                                                                                                                                                                                                                      |          |
