...
| U3 | 2    | [03-router.md](03-router.md)                 | edit | `plugins/stackgen/stacks/app-framework/swiftui/skills/swiftui/SKILL.md`                                                                                                                                                                                      | U1, U2     | green   |          |
...
| 2    | U3        | opus  | 2     | green       | Platforms lead-in rewritten: files keyed by the vwf token they realise (files are named for the platform, not the token)                                                                                                                                             |          |
