...
| U4 | 1    | [04-planners.md](04-planners.md)               | edit | `plugins/vwf/skills/change-plan/SKILL.md`, `plugins/vwf/skills/plan/SKILL.md`, `plugins/vwf/skills/plan/references/plan-doc.md`, `plugins/vwf/assets/plan-interview.md`, `plugins/vwf/assets/templates/plan-folder.md`                                                                                         | —              | pending |        |
| U5 | 2    | [05-docs.md](05-docs.md)                       | edit | `site/src/content/docs/plugins/vwf.md`, `site/src/content/docs/how-to/operate/ad-hoc-change.md`, `.claude/skills/vwf-plugin/references/skills-and-agents.md`, `.claude/skills/vwf-plugin/references/docs-tree.md`, `docs/memory/decisions/2026-09-25-partial-backlog-items.md` (new), `readme.md`, `CLAUDE.md` | U1, U2, U3, U4 | pending |        |
