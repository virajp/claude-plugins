...
| --- | ---- | ---------------------------------------------- | ------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------- | ------- | -------- |
| U12 | 1    | [12-this-repo.md](12-this-repo.md)             | edit   | `.config/pre-commit-config.yaml`, `.config/mise/tasks/code/graph` (new), `.config/mise/conf.d/tools.dev.toml`                                                                                                                                                                                                                                                                                                                                                                                      | —                      | green   | b9ec8de8 |
...
2. **Commit-gate forge links** (U6, wave 1) — the plan does not say who fills
   them once init stops; U6 assumed the skill fills them from `origin`. Handed
   to U2.
