...
| U4 | 4    | [04-gates-and-bump.md](04-gates-and-bump.md) | edit   | `plugins/stackgen/.claude-plugin/plugin.json`, `.claude-plugin/marketplace.json`, `site/package.json`, `plugins/stackgen/stacks/inventory.md`                                                                                                                                                            | U3         | green  |          |
...
| 4    | U4           | opus  | 1     | green       | site 1.1.44 → 1.1.45 (bare p:site:version, clean tree, first); stackgen 1.30.0 → 1.30.1 by hand; marketplace regenerated; inventory unchanged; all 9 gate lines green; no 13/17                                                                                                                                                                                                                                                                                                                          | —        |
