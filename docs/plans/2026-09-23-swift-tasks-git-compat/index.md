...
| -- | ---- | -------------------------------------------- | ------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------- | ------- | ------ |
| U1 | 1    | [01-swift-tasks.md](01-swift-tasks.md)       | edit   | `plugins/stackgen/stacks/language/swift/config/.config/mise/tasks/code/format`, `plugins/stackgen/stacks/language/swift/config/.config/mise/tasks/code/lint`, `plugins/stackgen/stacks/language/swift/conventions.md`, `plugins/stackgen/stacks/language/swift/skills/swift/references/build-and-run.md` | —          | green   |        |
...
| 1    | U1           | opus  | 2     | green       | loop-back from R1: the two scope comments now credit the any-depth list to the tasks, root-only excludes to swiftlint.yml; comments only; shellcheck green                                                                       | —      |
