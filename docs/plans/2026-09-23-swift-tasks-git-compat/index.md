...
| U3 | 3    | [03-docs.md](03-docs.md)                     | edit   | `site/src/content/docs/**`, `.claude/skills/stackgen-plugin/**`, `.claude/docs/**`, `readme.md`, `CLAUDE.md`, `plugins/stackgen/stacks/readme.md`                                                                                                                                                        | U1, R2     | green   |          |
...
| 3    | U3           | opus  | 2     | green       | W3 loop-back: fallback reworded to 'neither a .git entry nor GIT_DIR, or no git installed' in both docs; 'otherwise' limited to code:format; p:site:check green                                                                                                                                                                                                                                                                                                                                          | —        |
