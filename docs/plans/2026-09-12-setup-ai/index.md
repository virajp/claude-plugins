...
| -- | ---- | ---------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------- | ------- | ------ |
| U1 | 1    | [01-setup-ai-task.md](01-setup-ai-task.md)     | `plugins/stackgen/stacks/toolchain-manager/mise/config/.config/mise/tasks/setup/ai`                                                                                                                                       | —          | pending |        |
| U2 | 1    | [02-mise-pack-skill.md](02-mise-pack-skill.md) | `plugins/stackgen/stacks/toolchain-manager/mise/skills/**`, `.../mise/conventions.md`                                                                                                                                     | —          | pending |        |
| U3 | 1    | [03-vwf-init.md](03-vwf-init.md)               | `plugins/vwf/skills/init/**`                                                                                                                                                                                              | —          | pending |        |
