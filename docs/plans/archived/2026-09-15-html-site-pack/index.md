...
**COMPLETE** 2026-09-15 — commits b9f18f98, f266cb79, e28ea19a, 70f02793,
65fcba65 on branch `2026-09-15-html-site-pack`. `2026-09-15-html-site-pack`.
...
| -- | ---- | ---------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------- | ------ | ------------------ |
| U1 | 1    | [01-pack-and-bundle.md](01-pack-and-bundle.md) | `plugins/stackgen/stacks/framework/html/**`, `plugins/stackgen/stacks/bundles/html.md`, `plugins/stackgen/assets/taxonomy.md`, `plugins/stackgen/stacks/inventory.md` (regenerated)                     | —          | green  | b9f18f98           |
| U2 | 2    | [02-docs.md](02-docs.md)                       | `plugins/stackgen/stacks/readme.md`, `.claude/skills/stackgen-plugin/**`, `.claude/docs/**`, `CLAUDE.md`, `readme.md`, `site/src/content/docs/**`, `docs/memory/decisions/2026-09-15-html-site-pack.md` | U1         | green  | f266cb79           |
| U3 | 3    | [03-gates-and-bump.md](03-gates-and-bump.md)   | `plugins/stackgen/.claude-plugin/plugin.json`, `site/package.json`, `.claude-plugin/marketplace.json`                                                                                                   | U2         | green  | 70f02793, 65fcba65 |
...
| ---- | --------- | ----- | ----- | ----------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------ |
| 0    | preflight | —     | 1     | green       | all nine gate lines green on the develop base                                                                                                                                                                                                                                                                                                                                                                                                                                                      | —                  |
| 1    | U1        | opus  | 1     | returned    | DECIDED: vite@8.3.0 pass, html-validate@11.15.0 warn (one maintainer) — proceeded; Vite 8 top-level `input` (rollupOptions deprecated); SITE_ORIGIN exported const; counts 69→70 packs, 65→66 bundles, 13 kinds; throwaway proof green. GAP: no `contracts` key mirrored from Astro; html-validate not on Context7, verified from its site docs; references cite conventions.md by name (rule 13). DOCS FALSIFIED: stackgen.md, choosing-your-stack.md, stacks/readme.md, stackgen-plugin/SKILL.md |                    |
| 1    | R1        | opus  | 1     | findings(4) | conventions.md:176 + head.md:72,75,77 JSON-LD escape target lost (`\u003c`); conventions.md:206 111-char line in hand-folded file; conventions.md:95 copy-only adds `&& cp -R public/. dist/` beyond decision 3's quote (RULINGS); bundles/html.md:59 "No React" names the dropped pin. CONTRACT clean. Looped to U1                                                                                                                                                                               |                    |
| 1    | U1        | opus  | 2     | returned    | fixed all four: `\u003c` literal restored (written via perl — Write/Edit decode it), Stylesheets refolded, bundle wording drops "React". GAP: copy-only keeps `&& cp -R public/. dist/` beyond decision 3's quote — `public/` sits beside `src/`, a copy of `src/` alone drops robots, sitemap and brand assets                                                                                                                                                                                    |                    |
| 1    | R1        | opus  | 2     | pass        | FINDINGS: 0; CONTRACT clean; RULINGS clean                                                                                                                                                                                                                                                                                                                                                                                                                                                         |                    |
| 1    | U1        | opus  | —     | green       | wave gate all nine lines green; orchestrator gates green (rule-13 grep empty, icons byte-identical + exec, inventory 70/66/13 with four framework rows, throwaway vite build + html-validate exit 0)                                                                                                                                                                                                                                                                                               | b9f18f98           |
| 2    | U2        | opus  | 1     | returned    | edited stackgen.md, choosing-your-stack.md, vwf.md, stacks/readme.md, stackgen-plugin/SKILL.md, new decision record. DECIDED: readme.md, CLAUDE.md, .claude/docs untouched — no falsified count. GAP: docs-sync surveyor report was routed to the orchestrator and forwarded; survey also done by hand; decision record matches prior records (no AAAK header)                                                                                                                                     |                    |
| 2    | R2        | opus  | 1     | findings(1) | decisions/2026-09-15-html-site-pack.md:56 — decision 3 records one of its two rejected alternatives; "validating `dist/`" missing. CONTRACT clean, RULINGS clean. Looped to U2                                                                                                                                                                                                                                                                                                                     |                    |
| 2    | U2        | opus  | 2     | returned    | decision 3 now records both rejected alternatives; 1, 7, 8 already complete                                                                                                                                                                                                                                                                                                                                                                                                                        |                    |
| 2    | R2        | opus  | 2     | pass        | FINDINGS: 0; CONTRACT clean; RULINGS clean                                                                                                                                                                                                                                                                                                                                                                                                                                                         |                    |
| 2    | U2        | opus  | —     | green       | wave gate all nine lines green                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | f266cb79           |
| 3    | U3        | opus  | 1     | returned    | stackgen 1.19.0→1.20.0, marketplace regenerated, all nine gate lines green. GAP: `mise run p:site:version` refused ERR_PNPM_UNCLEAN_WORKING_TREE — the orchestrator's run-log edits to index.md were unstaged; orchestrator commits the run log and the stackgen bump first, then runs the site bump itself as a second ops commit                                                                                                                                                                 |                    |
| 3    | U3        | opus  | 2     | green       | orchestrator committed the run log (e28ea19a) and the stackgen bump, then ran `mise run p:site:version` bare → 1.1.22; full gate re-run green on the bumped tree                                                                                                                                                                                                                                                                                                                                   | 70f02793, 65fcba65 |
| 3    | R3        | opus  | 1     | pass        | FINDINGS: 0; CONTRACT clean; RULINGS clean — only the three owned files, vwf and installer untouched, no 13/17                                                                                                                                                                                                                                                                                                                                                                                     |                    |
