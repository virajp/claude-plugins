...
**COMPLETE** — 2026-09-06. Ran in worktree
`.worktrees/2026-09-06-init-behind-setup` on branch
`2026-09-06-init-behind-setup`, cut from `develop` at `d3abc802`. Commits:
`96b81eee` (wave 1, U1–U5), `71922f17` (wave 2, docs), `498698b8` (wave 3, the
bumps), plus the archiving commit. All seven units green; the wave gates, the
plan's own greps and the real-install verifier pass. One reviewer finding is
contested (a widow line in `init/references/readme-and-license.md:19`, left
after the two-round cap).
...
| -- | ---- | ------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------- | ------ | ---------- |
| U1 | 1    | [01-init.md](01-init.md)                         | `plugins/vwf/skills/init/**`                                                                                                                                                                                                                 | —          | green  | `96b81eee` |
| U2 | 1    | [02-setup.md](02-setup.md)                       | `plugins/vwf/skills/setup/**`                                                                                                                                                                                                                | —          | green  | `96b81eee` |
| U3 | 1    | [03-doctor.md](03-doctor.md)                     | `plugins/vwf/skills/doctor/**`                                                                                                                                                                                                               | —          | green  | `96b81eee` |
| U4 | 1    | [04-adapter-contract.md](04-adapter-contract.md) | `plugins/stackgen/skills/stackgen-stack-menu/SKILL.md`, `plugins/stackgen/skills/stackgen-stack-template/SKILL.md`, `scripts/src/check.ts`, `scripts/src/check.test.ts`, `.claude/skills/plugin-authoring/references/checks.md`              | —          | green  | `96b81eee` |
| U5 | 1    | [05-cross-references.md](05-cross-references.md) | `plugins/vwf/skills/readme/SKILL.md`, `plugins/stackgen/stacks/toolchain-manager/mise/skills/mise/references/task-library.md`, `plugins/stackgen/stacks/toolchain-gate/pre-commit/conventions.md`, `plugins/stackgen/stacks/bundles/mise.md` | —          | green  | `96b81eee` |
| U6 | 2    | [06-docs.md](06-docs.md)                         | `readme.md`, `CLAUDE.md`, `site/CLAUDE.md`, `site/src/content/docs/**`, `.claude/docs/**`, `.claude/skills/vwf-plugin/**`, `.claude/skills/stackgen-plugin/**`, `docs/memory/decisions/<run-date>-init-behind-setup.md`                      | U1–U5      | green  | `71922f17` |
| U7 | 3    | [07-gates-and-bump.md](07-gates-and-bump.md)     | `plugins/vwf/.claude-plugin/plugin.json`, `plugins/stackgen/.claude-plugin/plugin.json`, `.claude-plugin/marketplace.json`, `plugins/stackgen/stacks/inventory.md`                                                                           | U6         | green  | `498698b8` |
...
| 1    | U5              | opus  | 1     | green        | no-op: all 6 `/vwf:init` hits in the 4 owned files are actor descriptions (decision 5); DECIDED keep slash notation. GAP: `conventions.md:49` (re-run unnamed) and `bundles/mise.md:33` left as true actor statements — scope call for the reviewer                                                                                                                                                                                                                                                                                                                                                                                                                                           | `96b81eee` |
| 1    | U2              | opus  | 1     | green        | 2 files. DECIDED: `description` gains a `reshape` clause (beyond decision 7's hint-only); predicates named by subject only, evaluation left to doctor (decision 3); `reshape` is its own section before Step 0. DOCS FALSIFIED: CLAUDE.md:211, skills-and-agents.md:20, site vwf.md setup row+section, doctor stack-checks.md:212-215 (U3's)                                                                                                                                                                                                                                                                                                                                                  | `96b81eee` |
| 1    | U3              | opus  | 1     | green        | 2 files; "is not the remedy" gone; 5 remaining `/vwf:init` hits are actor/consent mentions. DECIDED: §9 severity block unchanged (names no remedy); harness/code-intelligence refs unchanged. DOCS FALSIFIED: skills-and-agents.md:32, site vwf.md:919,:929. GAP: verification expected a `reshape` hit at the §9 severity block — read the "one remedy" paragraph as that hit                                                                                                                                                                                                                                                                                                                | `96b81eee` |
| 1    | U4              | opus  | 1     | green        | 5 files; rule 9 gains `user-invocable: false` assertion beside the kept explicit line; tests both directions (scripts 124 pass). DECIDED: key placed right after `disable-model-invocation`; keyword-drop test uses both-keys fixture. DOCS FALSIFIED: site stackgen.md:706-707,:729; stackgen-plugin SKILL.md; vwf-plugin SKILL.md:132-134 (4th row); .claude/docs/plugins.md                                                                                                                                                                                                                                                                                                                | `96b81eee` |
| 1    | U1              | opus  | 1     | green        | 4 files; six questions (id-confirmation is q2); `argument-hint` removed; `user-invocable: false`; unlocks → `/vwf:setup reshape`; existing-repo pass 9 compares against confirmed ids + "customised id is neither" drift rule. DECIDED: blockquote under H1 (linter); per-question scope markers replace the two group headers; §7's inline slug mechanics dropped (citation only). GAP: `${STACK_ADAPTER_ROOT}` does not exist — cited as "the stack adapter's `assets/ids.md`" like §7 already does. DOCS FALSIFIED: site vwf.md:772,:823,:829,:907,:722,:927,:936-937,:1646,:1719,:1833; vwf-plugin SKILL.md:132-134; skills-and-agents.md:19; readme.md:111,:253; CLAUDE.md:153,:210,:339 | `96b81eee` |
| 1    | R1              | opus  | 1     | findings(9)  | CONTRACT clean; RULINGS clean. U1: readme-and-license.md:31,:50 question numbers stale after renumbering. U2: setup/SKILL.md:87 fold width. Docs unreported (→ U6): repo-shape.md:174 (rule 9 summary), site vwf.md:742 (invocation modes prose), skills-and-agents.md:19, vwf-plugin SKILL.md:73,:76, how-to trio fenced `/vwf:init` (single-repo.md:53, multi-repo.md:43,:133, onboard-existing-codebase.md:84), readme.md:111 / CLAUDE.md:339                                                                                                                                                                                                                                              | `96b81eee` |
| 1    | U1              | opus  | 2     | green        | readme-and-license.md: licence → q5, security contact → q6, stub names q1/q3 explicitly; tree-wide re-grep clean                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | `96b81eee` |
| 1    | U2              | opus  | 2     | green        | re-folded setup/SKILL.md Step 0 paragraph and two onboard-pipeline.md paragraphs to 68–79 cols; no wording change                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | `96b81eee` |
| 1    | R1              | opus  | 2     | findings(1)  | CONTRACT clean; RULINGS clean. readme-and-license.md:19 [U1] 4-char widow line "yet." — **contested** (loop capped at two rounds; cosmetic)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | `96b81eee` |
| 1    | gate            | —     | 1     | green        | plugins:check, marketplace --check, inventory --check, vitest 272, tsc ×2, npm-normalize 33, plan's 5 grep checks all as expected; site:check deferred to wave 2 (no site/ change in wave 1)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | `96b81eee` |
| 2    | docs-reconciler | opus  | 1     | findings(25) | written to `/tmp/init-behind-setup-reconciler.md` (site vwf.md ×10, stackgen.md ×2, readme.md, CLAUDE.md, vwf-plugin ×6, stackgen-plugin, repo-shape.md, how-to trio ×3); handed to U6 with the consolidated DOCS FALSIFIED list                                                                                                                                                                                                                                                                                                                                                                                                                                                              | `71922f17` |
| 2    | U6              | opus  | 1     | green        | 13 files (site vwf/stackgen/how-to ×3, readme, CLAUDE.md, vwf-plugin ×3, stackgen-plugin, repo-shape.md, new decisions doc). DECIDED: keep `/vwf:init` commands row marked Internal (table convention); fold single-repo init+setup into one setup step, retarget `#vwfinit` to the manual; drop reconciler's `plugins:check` sentence from the site manual; `/vwf:doctor` plain span (no anchor). GAP: fourth-row keys follow decision 1 not reconciler #16; `:936-937` says "stays model-invocable — and hidden" not "skill-invoked" (matches what landed); `.claude/docs/plugins.md` states no invocation state → unedited                                                                 | `71922f17` |
| 2    | R2              | opus  | 1     | findings(2)  | CONTRACT clean; RULINGS clean. vwf.md:843 "the second of them" ambiguous (ids is 2nd of six, 1st of the four); vwf-plugin SKILL.md:157 drops rule 4 from "rule 4 and `claude plugin validate` alone"                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | `71922f17` |
| 2    | U6              | opus  | 2     | green        | vwf.md preamble names both positions (first of the four, question 2 overall); vwf-plugin SKILL.md:157 → "rule 4 and `claude plugin validate` are all that check it"                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | `71922f17` |
| 2    | R2              | opus  | 2     | pass         | FINDINGS 0; CONTRACT clean; RULINGS clean                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | `71922f17` |
| 2    | gate            | —     | 1     | green        | plugins:check, marketplace --check, inventory --check, vitest 272, tsc ×2, npm-normalize 33, site:check (23 pages, 1441 links, 507 fragments, all resolve)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | `71922f17` |
| 3    | U7              | opus  | 1     | green        | vwf 19.13.0 → 19.14.0, stackgen 1.2.0 → 1.2.1, marketplace.json regenerated (refs vwf-v19.14.0, stackgen-v1.2.1), inventory.md byte-identical; full gate + plan's 5 greps green                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | `498698b8` |
| 3    | R3              | opus  | 1     | pass         | FINDINGS 0; CONTRACT clean; RULINGS clean                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | `498698b8` |
| 3    | gate            | —     | 1     | green        | plugins:check, marketplace --check (published + dev both fresh), inventory --check, vitest 274, tsc ×2, npm-normalize 33, site:check; versions 19.14.0 / 1.2.1, refs vwf-v19.14.0 / stackgen-v1.2.1                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | `498698b8` |
| 3    | target-verifier | opus  | 1     | pass         | hermetic install from `.dev-marketplace` (worktree copies, tags not cut): vwf 19.14.0 + stackgen 1.2.1 installed, `validate --strict` green, the three installed skills carry both keys, init has no `argument-hint`; init + both adapter skills absent from the user-invocable set (vwf 24 visible / 6 hidden, stackgen 1 visible); second install a byte-identical no-op; uninstall bookkeeping clean. One pre-existing finding: claude 2.1.260 leaves `.orphaned_at` cache trees after uninstall and `plugin prune` does not reclaim them — not this change's. CLI route installs the published pins (19.12.0 / 1.0.0) by design                                                           | `498698b8` |
