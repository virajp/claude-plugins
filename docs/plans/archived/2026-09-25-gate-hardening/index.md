...
COMPLETE 2026-09-25 — e1df8c5a e8a97ef7 baae5b84 76e2703c (wave 1), U5 fixes
746f9f52..bf9dd2e6, 3f5c6a60 (docs), bcc4c223 (versions); gaps open, folder
stays live
...
| U5 | 2    | [05-review.md](05-review.md)                   | review | —                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | U1, U2, U3 | green  |          |
| U6 | 3    | [06-docs.md](06-docs.md)                       | edit   | `site/src/content/docs/**`, `.claude/skills/stackgen-plugin/**`, `.claude/skills/plugin-authoring/**`, `.claude/docs/**`, `readme.md`, `CLAUDE.md`, `plugins/stackgen/stacks/readme.md`                                                                                                                                                                                                                                                                                            | U4, U5     | green  | 3f5c6a60 |
| U7 | 4    | [07-gates-and-bump.md](07-gates-and-bump.md)   | edit   | every `plugins/stackgen/stacks/*/*/pack.yaml` of a pack the branch changed, `plugins/stackgen/stacks/bundles/*.md`, `plugins/stackgen/stacks/inventory.md`, `.claude-plugin/marketplace.json`                                                                                                                                                                                                                                                                                      | U6         | green  | bcc4c223 |
...
- **U5 — contested at the round cap** (4 rounds; the contract, not the loop,
  ...
  - (U1, LOW) the five `code:lint` tasks stop with mise's raw error when the
    ...
    the cause.
- **U5-late1 — oscillation at the convergence guard** (re-run 1, rounds 2–3, one
  finding each): U1's rewording of `toolchain-manager/mise/conventions.md` lines
  41–42 traded a double negative for a semicolon inside a dashed aside. The
  loop, not the contract, failed to settle; suggested wording "or, where the
  packs pin no `node` (swift, swiftui and flutter pin none), the machine's".
  Contested; non-blocking.
...
| 2    | U5         | opus  | 5     | security: pass              | round-4 LOW resolved; no findings open. Row green: review stage ended at the cap (2 contested), security clean; main loop to = 1085d100                                                                                                                                                                                                                                                                                                                                                  | —        |
| 2    | R2         | opus  | 1     | findings(1)                 | U1 LOW: mise code/lint:19 comment says the prose linter would drag Node into a docs-only repo, but the base pin now installs it everywhere — looped back. CONTRACT clean, RULINGS clean. Docs for U6: site stackgen.md:714, :838-843, :717-720 (sidecar, recorded gap)                                                                                                                                                                                                                   | —        |
| 2    | U1         | opus  | 6     | green                       | R2 fix: mise default code:lint comment says why it does not call the base-pinned linter                                                                                                                                                                                                                                                                                                                                                                                                  | a6b7abe4 |
| 2    | R2         | opus  | 2     | pass                        | U1 comment fix verified; comments only                                                                                                                                                                                                                                                                                                                                                                                                                                                   | —        |
| 2    | gate       | —     | 1     | green                       | wave gate 9/9 green; no UNRESOLVED                                                                                                                                                                                                                                                                                                                                                                                                                                                       | —        |
| 2    | U5         | opus  | 1     | security: pass              | re-run 1 (U5-late1), range a6b7abe4^..a6b7abe4: comment lines only                                                                                                                                                                                                                                                                                                                                                                                                                       | —        |
| 2    | U5         | opus  | 1     | review: findings(2)         | re-run 1 (U5-late1): U1 LOW task-library.md:255 stale reason; U1 LOW mise.toml:166 and conventions.md:42 list uv as a node-reliant caller — looped back                                                                                                                                                                                                                                                                                                                                  | —        |
| 2    | U1         | opus  | 7     | green                       | U5-late1 fix: task-library.md slot reason aligned; uv dropped from node-reliant callers in mise.toml and conventions.md                                                                                                                                                                                                                                                                                                                                                                  | ff3a0901 |
| 2    | U5         | opus  | 2     | security: pass              | re-run 1 (U5-late1), range a6b7abe4^..ff3a0901: comments and markdown only                                                                                                                                                                                                                                                                                                                                                                                                               | —        |
| 2    | U5         | opus  | 2     | review: findings(1)         | re-run 1 (U5-late1): round-1 fixes verified; U1 LOW conventions.md:42 double negative — looped back                                                                                                                                                                                                                                                                                                                                                                                      | —        |
| 2    | U1         | opus  | 8     | green                       | U5-late1 r2 fix: conventions.md:42 double negative reworded                                                                                                                                                                                                                                                                                                                                                                                                                              | bf9dd2e6 |
| 2    | U5         | opus  | 3     | security: pass              | re-run 1 (U5-late1), range a6b7abe4^..bf9dd2e6: markdown only                                                                                                                                                                                                                                                                                                                                                                                                                            | —        |
| 2    | U5         | opus  | 3     | review: findings(1) — guard | re-run 1 (U5-late1): round-2 finding fixed; U1 LOW conventions.md:41-42 semicolon inside the dashed aside. Count 1 → 1, not strictly decreasing: convergence guard ends the loop, finding contested (oscillation). re-run 1: 3 rounds                                                                                                                                                                                                                                                    | —        |
| 2    | R2-late    | opus  | 1     | pass                        | ff3a0901, bf9dd2e6 within U1 Owns; prose only; B1 unchanged                                                                                                                                                                                                                                                                                                                                                                                                                              | —        |
| 2    | gate       | —     | 2     | green                       | wave gate 9/9 green after the late re-run                                                                                                                                                                                                                                                                                                                                                                                                                                                | —        |
...
| 3    | U6         | opus  | 1     | green                       | site plugins/stackgen.md: four passages (SwiftLint conf.d, linter.yaml in pre-commit pack + require_serial, lock + sidecar, runtime-only exception). This repo's own .config prose left for reshape (B6). GAP: docs-sync surveyor returned no report; survey done by grep over Owns                                                                                                                                                                                                      | 3f5c6a60 |
| 3    | R3         | opus  | 1     | findings(2)                 | site stackgen.md:1083 "marker for the language linter nobody has pinned" stale; :811 mise.toml row says runtime [tools] only — looped to U6. CONTRACT clean, RULINGS clean                                                                                                                                                                                                                                                                                                               | —        |
| 3    | U6         | opus  | 2     | green                       | R3 fix: mise.toml table row names the linter pin; code/lint marker passage reworded                                                                                                                                                                                                                                                                                                                                                                                                      | 3f5c6a60 |
| 3    | R3         | opus  | 2     | pass                        | both fixes verified                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | —        |
| 3    | gate       | —     | 1     | green                       | wave gate 9/9 green; no UNRESOLVED                                                                                                                                                                                                                                                                                                                                                                                                                                                       | —        |
| 4    | U7         | opus  | 1     | green                       | patch bumps: mise 1.6.1, pnpm 0.3.1, flutter 0.4.1, eslint 0.3.1, swift 0.1.1, ruff 0.3.1, repo-hygiene 1.2.3; swiftui and pre-commit already bumped since stackgen-v1.31.0 (B8); pre-commit summary names linter.yaml; 20 bundle pins; inventory regenerated; marketplace no diff                                                                                                                                                                                                       | bcc4c223 |
| 4    | R4         | opus  | 1     | pass                        | 28 files in Owns; B8 bumps and pins verified; no 13/17                                                                                                                                                                                                                                                                                                                                                                                                                                   | —        |
| 4    | gate       | —     | 1     | green                       | wave gate 9/9 green after U7                                                                                                                                                                                                                                                                                                                                                                                                                                                             | —        |
| —    | reconcile  | —     | 1     | green                       | final wave gate 9/9 green; orchestrator gates 1-5 pass: no pnpm dlx linter; lint hook require_serial; one linter.yaml (pre-commit pack); hygiene payload dprint check exit 0; every code/format passes dprint ./-prefixed paths after --                                                                                                                                                                                                                                                 | —        |
