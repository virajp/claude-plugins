...
(`argument-hint`, `model: opus`, `effort: medium`,
...
| 11 | Model                             | Both `model: opus`, `effort: medium`, as every other vwf workflow skill.                                                                                                                                                                                                                                                                                                                                                          | `fable` for change-plan (the repo copy's choice)       | U1, U2 |
