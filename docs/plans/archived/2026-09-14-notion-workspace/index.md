...
| U4 | 4    | [04-gates-and-bump.md](04-gates-and-bump.md)         | `plugins/stackgen/.claude-plugin/plugin.json`, `site/package.json`, `.claude-plugin/marketplace.json`                                                                                                                                                                                                                                                                | U3         | green  | 85e21924 |
...
| 4    | U4        | opus  | 1     | re-run      | site 1.1.15→1.1.16 by hand, stackgen 1.12.0→1.14.0, marketplace regenerated; all gate lines green. GAP: mise run p:site:version refused (ERR_PNPM_UNCLEAN_WORKING_TREE — the untracked .config/mise*.lock files from setup:worktree count as dirty); orchestrator moved the two lock files to /tmp (mise run does not recreate them) and re-dispatched so the consented command runs                                                                                                                                                                       |          |
| 4    | U4        | opus  | 2     | green       | Wave gate green, nine lines; orchestrator gates green. mise run p:site:version (bare) ran on the clean tree: site 1.1.15→1.1.16; stackgen 1.12.0→1.14.0 (1.13.0 skipped); marketplace regenerated, ref stackgen-v1.14.0. Round-1 GAP closed                                                                                                                                                                                                                                                                                                                |          |
| 4    | R4        | opus  | 1     | pass        | Versions and the two generator-derived marketplace fields only; vwf and installer untouched                                                                                                                                                                                                                                                                                                                                                                                                                                                                | 85e21924 |
