...
COMPLETE 2026-09-20 — 517cca88 5c6f93db 1db4af49 f9b13ae0 ae234533 a4802687 (+
folder commits bd4e6f23 c46c2364)
...
| U5 | 2    | [05-docs.md](05-docs.md)                           | edit | `readme.md`, `CLAUDE.md`, `.claude/docs/repo-shape.md`, `.claude/skills/vwf-plugin/**`, `.claude/skills/stackgen-plugin/SKILL.md`, `site/src/content/docs/**`, `docs/memory/decisions/2026-09-20-init-forge-pass.md` | U1, U2, U3, U4 | green  | ae234533 |
| U6 | 3    | [06-gates-and-bump.md](06-gates-and-bump.md)       | edit | `plugins/vwf/.claude-plugin/plugin.json`, `plugins/stackgen/.claude-plugin/plugin.json`, `site/package.json`, `.claude-plugin/marketplace.json`                                                                      | U5             | green  | a4802687 |
...
Three plan holes, each resolved at run time by an orchestrator ruling, recorded
in `docs/memory/decisions/2026-09-20-init-forge-pass.md` — none open:

- **Question count** — "seven questions" is seven rounds: Q6 visibility is round
  6, Q6a licence and Q6b security contact together are round 7.
- **Predicate (g) vs idempotence** — a branch counts as protected when any
  ruleset or protection exists; drift only when none; a missing decision-4 rule
  is an informational note. The default-branch check is `develop` or `main`.
- **Whole-contact slots** — `SECURITY.md`'s and the issue chooser's `<REPO_URL>`
  carry the whole security contact; init fills them with a URL contact and
  removes the chooser entry for an email or a decline.
...
| 2    | U5 docs              | opus                          | 1     | pass        | edit; 12 files; decisions doc + 2 Superseded-by lines. DECIDED: repo-shape.md:283, multi-repo.md left (nothing false); 'licence Relay chose' kept. GAP: docs-sync surveyor hand-back failed (relayed by orchestrator; its findings all inside the plan's list) — grep sweep covered scope. precommit + site:check green                                                                                                      | ae234533 |
| 2    | R2                   | opus                          | 1     | findings(2) | review; vwf.md:1010 'Four are asked' vs skill's 'the other five'; readme.md:80 + vwf.md:196 say project scope where the pass needs repo (project only for the backlog step). Contract clean, rulings clean                                                                                                                                                                                                                   | —        |
| 2    | U5 docs              | opus                          | 2     | pass        | edit; R2 fixes — vwf.md count matches the skill's 'other five'; gh scopes split repo/project in readme.md and vwf.md                                                                                                                                                                                                                                                                                                         | ae234533 |
| 2    | R2                   | opus                          | 2     | pass        | review; both fixes landed; contract clean, rulings clean                                                                                                                                                                                                                                                                                                                                                                     | —        |
| 2    | wave gate            | —                             | 1     | pass        | all five lines green (precommit pass 1 reflowed the plan folder only)                                                                                                                                                                                                                                                                                                                                                        | —        |
| —    | reconcile            | —                             | 1     | skipped     | why: no covers: (no stamps, registry, environment or harness edits) and no code unit (nothing to persist beyond the Run log)                                                                                                                                                                                                                                                                                                 | —        |
| 3    | U6 gates-and-bump    | opus                          | 1     | pass        | edit; vwf 19.36.0, stackgen 1.20.2, site 1.1.31, marketplace regenerated; five gate lines green                                                                                                                                                                                                                                                                                                                              | a4802687 |
| 3    | R3                   | sonnet (downgraded from opus) | 1     | pass        | review; scope, versions, refs, JSON all clean                                                                                                                                                                                                                                                                                                                                                                                | —        |
| 3    | wave gate            | —                             | 1     | pass        | all five lines green                                                                                                                                                                                                                                                                                                                                                                                                         | —        |
| —    | final gate           | —                             | 1     | pass        | wave gate over the finished tree green (same run); orchestrator gates: none beyond the wave gate                                                                                                                                                                                                                                                                                                                             | —        |
