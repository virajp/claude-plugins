...
| -- | ---- | -------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------- | ------- | ------ |
| U1 | 1    | [01-init.md](01-init.md)                     | `plugins/vwf/skills/init/**`                                                                                                                                        | —          | pending |        |
| U2 | 1    | [02-doctor.md](02-doctor.md)                 | `plugins/vwf/skills/doctor/**`                                                                                                                                      | —          | pending |        |
| U3 | 1    | [03-setup-step0.md](03-setup-step0.md)       | `plugins/vwf/skills/setup/SKILL.md`                                                                                                                                 | —          | pending |        |
| U4 | 2    | [04-docs.md](04-docs.md)                     | `site/src/content/docs/**`, `readme.md`, `CLAUDE.md`, `.claude/docs/**`, `.claude/skills/**`, `docs/memory/decisions/2026-09-12-*.md`, every `DOCS FALSIFIED:` path | U1–U3      | pending |        |
