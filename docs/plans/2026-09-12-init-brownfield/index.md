...
**RUNNING** — resumed 2026-09-12 after ruling 4 was decided (see the decisions
table and [06-config-format.md](06-config-format.md)). U3 green at `2fc4c26e`;
U1, U2, U4, U5 reset to pending; U6 added. Worktree
...
| -- | ---- | -------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------- | ------- | -------- |
| U1 | 1    | [01-init.md](01-init.md)                     | `plugins/vwf/skills/init/**`                                                                                                                                                                                                                                                                                                    | —          | green   | 49b2d203 |
...
| U4 | 2    | [04-docs.md](04-docs.md)                     | `site/src/content/docs/**`, `readme.md`, `CLAUDE.md`, `.claude/docs/**`, `.claude/skills/**`, `docs/memory/decisions/2026-09-12-*.md`, every `DOCS FALSIFIED:` path, plus (widened at run time by R1; unconditional since ruling 4 was decided) `plugins/vwf/skills/architecture/SKILL.md:378`; `vwf-config.md:195` is now U6's | U1–U3, U6  | green   | 7957e3d1 |
| U5 | 3    | [05-gates-and-bump.md](05-gates-and-bump.md) | `plugins/vwf/.claude-plugin/plugin.json`, `.claude-plugin/marketplace.json`, `site/package.json`                                                                                                                                                                                                                                | U4         | pending |          |
