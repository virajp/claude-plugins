...
| 2    | U6           | opus  | 1     | green        | eleven human-facing docs reconciled — CLAUDE.md, `.claude/skills/vwf-plugin/**` (4 files), `.claude/skills/stackgen-plugin/SKILL.md`, three site pages, the brownfield how-tos — plus the new decisions doc. DECIDED: `readme.md` left untouched, no falsified claim; the site's doctor drift list gains the three config-read rows; docs-tree's "21 without a config bump" now reads "blueprint 21". No gap                                                                                                                                                                                                                                                   | a8de504e |
| 2    | R2           | opus  | 1     | findings(2)  | CONTRACT clean, RULINGS clean but for one understatement — vwf.md:1640 described doctor's provider row as "a pinned secrets provider" where decision 6 keys it on `answers.secrets`. Second finding was untracked `.vitest/` gate residue, removed by the orchestrator, not a U6 edit                                                                                                                                                                                                                                                                                                                                                                          |          |
| 2    | U6           | opus  | 2     | green        | fix: vwf.md:1640 and `skills-and-agents.md`:40 now read "a provider named by `answers.secrets`", matching U5's landed wording                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | a8de504e |
| 2    | R2           | opus  | 2     | findings(1)  | CONTRACT clean, RULINGS clean; round-1 fix verified in both places. One new stale count — `migrate-old-vwf-repo.md`:69 said "Three lineage rows" over four. Converging 2 → 1 but the two-round cap was spent                                                                                                                                                                                                                                                                                                                                                                                                                                                   |          |
| 2    | U6           | opus  | 3     | green        | fix outside the review loop: the count corrected to "Four"; swept the rest of the wave-2 diff for stale enumerations, none found. Verified by R3 rather than a third R2 round                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | a8de504e |
