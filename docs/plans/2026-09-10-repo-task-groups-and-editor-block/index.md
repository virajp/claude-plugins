...
| -- | ---- | ---------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------- | ------- | ------ |
| U1 | 1    | [01-rename.md](01-rename.md)                   | `.config/mise/tasks/{i,plugins,site}/**` → `.config/mise/tasks/p/{i,plugins,site}/**`; `.config/mise/tasks/code/format`; `.config/pre-commit-config.yaml`; `.github/workflows/{plugins,release,deps-update,site}.yml`; `.config/mise.toml`; `.config/mise.dev.toml`; `.gitignore`                                                                                                                                                                                                                         | —          | pending |        |
| U2 | 1    | [02-bash.md](02-bash.md)                       | `.config/mise/tasks/code/git-config`, `.config/mise/tasks/code/count`, `.config/mise/tasks/code/all`                                                                                                                                                                                                                                                                                                                                                                                                      | —          | pending |        |
| U3 | 1    | [03-editor-block.md](03-editor-block.md)       | `.config/vscode.d/**` (new), `.vscode/settings.json`, `.vscode/extensions.json`, `.config/mise/tasks/setup/vscode` (new)                                                                                                                                                                                                                                                                                                                                                                                  | —          | pending |        |
| U4 | 1    | [04-renovate.md](04-renovate.md)               | `.config/renovate.json` → `renovate.json`                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | —          | pending |        |
| U5 | 1    | [05-scripts-strings.md](05-scripts-strings.md) | `scripts/src/inventory.ts`, `scripts/src/marketplace.ts`, `scripts/src/check.ts`, `scripts/src/plugins.ts`, `scripts/src/check.test.ts`, `scripts/src/inventory.test.ts`, `scripts/src/marketplace.test.ts`, `installer/src/mempalace-checkpoint-script.test.ts`                                                                                                                                                                                                                                          | —          | pending |        |
| U6 | 2    | [06-docs.md](06-docs.md)                       | `CLAUDE.md`, `installer/CLAUDE.md`, `site/CLAUDE.md`, `readme.md`, `.claude/docs/**`, `.claude/skills/**`, `.claude/agents/target-verifier.md`, `site/src/content/docs/**`, and the eight plugin-shipped lines: `plugins/vwf/assets/stack-adapter.md`, `plugins/vwf/vendor/mempalace/README.md`, `plugins/vwf/skills/blueprint-authoring/references/api-and-schema-contracts.md`, `plugins/stackgen/stacks/readme.md`, `plugins/stackgen/assets/output-tree.md`, `plugins/stackgen/assets/pack-format.md` | U1–U5      | pending |        |
| U7 | 3    | [07-gates-and-bump.md](07-gates-and-bump.md)   | `plugins/vwf/.claude-plugin/plugin.json` (conditional), `plugins/stackgen/.claude-plugin/plugin.json` (conditional), `plugins/stackgen/stacks/inventory.md` (generated), `.claude-plugin/marketplace.json` (generated)                                                                                                                                                                                                                                                                                    | U6         | pending |        |
