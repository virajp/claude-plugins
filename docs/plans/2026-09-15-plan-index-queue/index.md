...
| -- | ---- | -------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------- | ------- | ------ |
| U1 | 1    | [01-change-plan.md](01-change-plan.md)       | `plugins/vwf/skills/change-plan/**`                                                                                                                                                                                                                                                  | —          | pending |        |
| U2 | 1    | [02-change-execute.md](02-change-execute.md) | `plugins/vwf/skills/change-execute/**`                                                                                                                                                                                                                                               | —          | pending |        |
| U3 | 1    | [03-index-contract.md](03-index-contract.md) | `plugins/vwf/assets/plan-index.md` (new), `plugins/vwf/skills/archive/SKILL.md`, `plugins/vwf/assets/membership.md`, `plugins/vwf/assets/topologies/multi-repo.md`, `plugins/vwf/skills/plan/SKILL.md`, `plugins/vwf/skills/execute/SKILL.md`, `plugins/vwf/skills/backlog/SKILL.md` | —          | pending |        |
| U4 | 2    | [04-docs.md](04-docs.md)                     | `.claude/skills/vwf-plugin/**`, `site/src/content/docs/**`, `readme.md`, `CLAUDE.md`, `docs/plans/index.md`, `docs/memory/decisions/2026-09-15-plan-index-queue.md`                                                                                                                  | U1, U2, U3 | pending |        |
