...
| U4 | 3    | [04-docs.md](04-docs.md)                     | edit | `CLAUDE.md`, `readme.md`, `.claude/skills/vwf-plugin/**`, `site/src/content/docs/plugins/vwf.md`, `site/src/content/docs/how-to/operate/ad-hoc-change.md`, `docs/memory/decisions/2026-09-18-plan-management.md`, `plugins/vwf/assets/topologies/multi-repo.md` (widened at run time — U3's DOCS FALSIFIED)                                         | U2, U3     | running |          |
...
| 3    | U4 docs     | opus  | 2     | pass        | edit; docs-tree.md:49 seam fixed                                                                                                                                                                                                                                                                                                                                                                                          | —        |
