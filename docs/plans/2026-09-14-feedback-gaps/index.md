...
| U3 | 2    | [03-docs.md](03-docs.md)                     | `readme.md`, `CLAUDE.md`, `.claude/**`, `site/src/content/docs/**`, `docs/backlog.md`, `docs/memory/decisions/2026-09-14-feedback-gaps.md` (new) | U1, U2     | green   |          |
...
| 2    | U3        | opus  | 2     | green       | R2's two findings fixed: "The routes:"; feature-idea path line carries the blueprint hop in both branches. `p:site:check` green                                                                                                                                                                                                                                                                 | —        |
