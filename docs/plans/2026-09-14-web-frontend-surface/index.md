...
**RUNNING** since 2026-09-14, worktree
`.worktrees/2026-09-14-web-frontend-surface`, branch
`2026-09-14-web-frontend-surface`.
...
| U5 | 3    | [05-docs.md](05-docs.md)                             | `readme.md`, `CLAUDE.md`, `.claude/**`, `site/src/content/docs/**`, `docs/backlog.md`; widened at run time by R1 round 1 (rule 5, nobody-owned): `plugins/vwf/assets/examples/blueprint/**`, `plugins/stackgen/stacks/readme.md`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | all        | pending |          |
