...
| 2    | R2        | opus  | 2     | pass        | All three fixes landed, nothing else moved; the node squaring checked against `<rect rx>` alone, `<rect rx ry>`, `<ellipse>` and `<circle>` — rects zeroed, the rest untouched; task 755, shellcheck/shfmt/rule 13 clean                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |          |
