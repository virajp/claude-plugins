...
| --- | ---- | ---------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------- | ------- | ------ |
| U1  | 1    | [01-taxonomy.md](01-taxonomy.md)                           | `plugins/stackgen/assets/taxonomy.md`                                                                                                                                                                                                                                                                                          | —          | pending |        |
| U2  | 1    | [02-provider-narrowing.md](02-provider-narrowing.md)       | `plugins/stackgen/stacks/cloud-provider/cloudflare/**`; the reservation passages only in `stacks/cloud-service/workers-ssr/**`, `stacks/cloud-service/workers-static-assets/**`, `stacks/bundles/cloudflare-workers-ssr.md`, `stacks/bundles/cloudflare-workers-static.md`, `stacks/bundles/cloudflare-zero-trust.md`          | —          | pending |        |
