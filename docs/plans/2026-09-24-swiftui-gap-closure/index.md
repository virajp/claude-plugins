...
| -- | ---- | ------------------------------------------------ | ------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------- | ------- | ------ |
| U1 | 1    | [01-pack-format.md](01-pack-format.md)           | edit   | `plugins/stackgen/assets/pack-format.md`, `plugins/stackgen/assets/taxonomy.md`, `plugins/stackgen/assets/output-tree.md`, `plugins/stackgen/skills/stackgen-stack-template/**`                                           | —          | green   |        |
| U2 | 1    | [02-checker.md](02-checker.md)                   | edit   | `scripts/src/check.ts`, `scripts/src/check.test.ts`                                                                                                                                                                       | —          | green   |        |
| U3 | 1    | [03-vwf-doctor-setup.md](03-vwf-doctor-setup.md) | edit   | `plugins/vwf/skills/doctor/**`, `plugins/vwf/skills/setup/SKILL.md`, `plugins/vwf/skills/setup/references/materialize.md`, `plugins/vwf/assets/stack-adapter.md`, `plugins/vwf/assets/stack-vocabulary.md`                | —          | green   |        |
| U4 | 1    | [04-swiftui.md](04-swiftui.md)                   | edit   | `plugins/stackgen/stacks/app-framework/swiftui/**`, `plugins/stackgen/stacks/bundles/swift-swiftui.md`                                                                                                                    | —          | green   |        |
| U5 | 1    | [05-swiftpm.md](05-swiftpm.md)                   | edit   | `plugins/stackgen/stacks/package-manager/swiftpm/**`, `plugins/stackgen/stacks/bundles/swift-package.md`                                                                                                                  | —          | green   |        |
| U6 | 1    | [06-gate-packs.md](06-gate-packs.md)             | edit   | `plugins/stackgen/stacks/toolchain-gate/dprint/**`, `plugins/stackgen/stacks/toolchain-gate/pre-commit/**`, `plugins/stackgen/stacks/bundles/repo-gates.md`                                                               | —          | green   |        |
