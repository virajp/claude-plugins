...
| -- | ---- | ---------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------- | ------- | ------ |
| U1 | 1    | [01-workspace-category.md](01-workspace-category.md) | `plugins/stackgen/assets/taxonomy.md`, `plugins/stackgen/assets/kinds.md` (only where a cross-reference needs it), `plugins/stackgen/assets/contracts/workspace.md` (new), `plugins/stackgen/stacks/readme.md` | —          | pending |        |
| U2 | 2    | [02-notion-pack.md](02-notion-pack.md)               | `plugins/stackgen/stacks/capability-provider/notion/**` (new), `plugins/stackgen/stacks/bundles/notion.md` (new), `plugins/stackgen/stacks/inventory.md`                                                       | U1         | pending |        |
| U3 | 3    | [03-docs.md](03-docs.md)                             | `readme.md`, `CLAUDE.md`, `.claude/**`, `site/src/content/docs/**`                                                                                                                                             | U1–U2      | pending |        |
| U4 | 4    | [04-gates-and-bump.md](04-gates-and-bump.md)         | `plugins/stackgen/.claude-plugin/plugin.json`, `site/package.json`, `.claude-plugin/marketplace.json`                                                                                                          | U3         | pending |        |
