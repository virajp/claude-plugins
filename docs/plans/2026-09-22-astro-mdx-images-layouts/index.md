...
| U4 | 2    | [04-wiring.md](04-wiring.md)                 | edit | `plugins/stackgen/stacks/framework/astro/skills/astro/SKILL.md`, and under `skills/astro/references/`: `ssg.md`, `ssr.md`, `hybrid.md`, `csr.md`, `content-and-routing.md`                                                                                                       | U1, U2, U3 | green   |          |
...
| 2    | U4 wiring  | opus  | 2     | pass        | edit; R2 fix — Images row now reads `<Image>` from `astro:assets`                                                                                                                                                                                                                                                                                                     | —        |
