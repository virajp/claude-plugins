...
| -- | ---- | -------------------------------------------- | ---- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------- | ------- | ------ |
| U1 | 1    | [01-mdx.md](01-mdx.md)                       | edit | `plugins/stackgen/stacks/framework/astro/skills/astro/references/mdx.md`                                                                                                                                                                                                         | —          | pending |        |
| U2 | 1    | [02-images.md](02-images.md)                 | edit | `plugins/stackgen/stacks/framework/astro/skills/astro/references/images.md`                                                                                                                                                                                                      | —          | pending |        |
| U3 | 1    | [03-layouts.md](03-layouts.md)               | edit | `plugins/stackgen/stacks/framework/astro/skills/astro/references/layouts.md`                                                                                                                                                                                                     | —          | pending |        |
