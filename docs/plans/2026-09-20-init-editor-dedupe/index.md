...
| -- | ---- | ------------------------------------------------ | ---- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------- | ------- | ------ |
| U1 | 1    | [01-init.md](01-init.md)                         | edit | `plugins/vwf/skills/init/SKILL.md`, `plugins/vwf/skills/init/references/fragments-and-sections.md`, `plugins/vwf/skills/init/references/existing-repo.md`                                                               | —          | pending |        |
| U2 | 1    | [02-config-and-setup.md](02-config-and-setup.md) | edit | `plugins/vwf/assets/vwf-config.md`, `plugins/vwf/skills/setup/SKILL.md`                                                                                                                                                 | —          | pending |        |
| U3 | 1    | [03-pack-format.md](03-pack-format.md)           | edit | `plugins/stackgen/assets/pack-format.md`                                                                                                                                                                                | —          | pending |        |
| U4 | 2    | [04-docs.md](04-docs.md)                         | edit | `readme.md`, `CLAUDE.md`, `.claude/docs/repo-shape.md`, `.claude/skills/vwf-plugin/**`, `.claude/skills/stackgen-plugin/SKILL.md`, `site/src/content/docs/**`, `docs/memory/decisions/2026-09-20-init-editor-dedupe.md` | U1, U2, U3 | pending |        |
