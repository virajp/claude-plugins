...
| 3    | U5         | opus  | 1     | green       | swift-format and swiftlint 0.1.0 → 0.1.1 with their pins in swift-package and swift-swiftui bundles; swiftpm and swiftui already bumped since the tag, left; inventory regenerated; marketplace.json regenerated byte-identical; no plugin.json or site bump                                                                                                                          |          |
