...
| `docs/plans/archived/2026-09-20-init-mode-seam` | change | init mode seam — three modes from evidence, the stack read, conflicts offered in every mode | —           | 20       | COMPLETE | 2026-09-20-pack-first-run-safety | B28      |
| `docs/plans/2026-09-20-init-brownfield-reads`   | change | init brownfield reads — root configs, hooks, tasks and .gitignore read first                | —           | 30       | RUNNING  | 2026-09-20-init-mode-seam        | B28      |
