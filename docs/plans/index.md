...
| docs/plans/2026-09-26-init-commits-the-lock        | change | init commits the lock — the first CI run of a shaped repo finds its mise lock      | —           | 40       | APPROVED | 2026-09-26-mise-conf-d-packs                                           | B67         |
