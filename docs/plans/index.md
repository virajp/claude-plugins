...
| docs/plans/2026-09-23-swiftui-app-stack            | change | SwiftUI app stack — the swiftui pack, Tuist, goldens, topics 1–11, the swift-swiftui bundle            | —           | 40       | COMPLETE | 2026-09-23-swift-package-stack, 2026-09-23-swift-tasks-git-compat | —       |
| docs/plans/archived/2026-09-24-swiftui-gap-closure | change | SwiftUI gap closure — binary probes, lockfile paths, machine env, the ux-gate, swiftpm, asset catalogs | —           | 10       | COMPLETE | —                                                                 | —       |
| docs/plans/2026-09-23-swiftui-platform-doctrine    | change | SwiftUI platform doctrine — per-platform references and Apple core integrations                        | —           | 50       | APPROVED | 2026-09-23-swiftui-app-stack, 2026-09-24-swiftui-gap-closure      | B56     |
