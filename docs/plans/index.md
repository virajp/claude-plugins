...
| ----------------------------------- | ------ | ------------------------------------------------------------------------------------------------------- | ----------- | -------- | -------- | -------- | ------- |
| `docs/plans/2026-09-17-review-rows` | change | Review rows — the plan places the code and security review; after-landing steps run on recorded consent | —           | 10       | APPROVED | —        | —       |
