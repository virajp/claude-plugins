...
| docs/plans/2026-09-26-mise-conf-d-layout           | change | mise conf.d layout — section files, one lock for every environment                        | —           | 10       | RUNNING  | —                                       | B54 (piece)              |
...
| docs/plans/2026-09-26-tool-config-mise             | change | tool-config mise — a stackgen skill owns mise config; packs call it                       | —           | 30       | APPROVED | 2026-09-26-mise-lock-sidecar-exclusions | B54, B66 (piece)         |
