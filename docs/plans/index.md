...
| [`2026-09-14-notion-workspace`](2026-09-14-notion-workspace/index.md)         | notion workspace — a workspace category, its contract, and the notion capability-provider pack                                      | APPROVED | —                                 | B09     |
...
`archived/` is satisfied. `feedback-gaps` and `notion-workspace` can start now,
in either order; the other three run in the order listed.
