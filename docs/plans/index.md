...
| `docs/plans/2026-09-20-branch-model`                   | change | branch model — landing model per branch; the git pass reads where it stands               | —           | 40       | RUNNING  | 2026-09-20-init-brownfield-reads | B28, B53 |
