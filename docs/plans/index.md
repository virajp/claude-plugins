...
| docs/plans/2026-09-24-swiftui-gap-closure       | change | SwiftUI gap closure — binary probes, lockfile paths, machine env, the ux-gate, swiftpm, asset catalogs | —           | 10       | COMPLETE | —                                                                 | —       |
