...
| docs/plans/2026-09-26-init-commits-the-lock        | change | init commits the lock — the first CI run of a shaped repo finds its mise lock      | —           | 50       | APPROVED | 2026-09-26-mise-config-skill  | B67         |
