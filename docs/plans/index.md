...
| docs/plans/2026-09-23-swift-tasks-git-compat    | change | Swift tasks git compatibility — no silent pass when git ls-files fails                              | —           | 40       | COMPLETE | 2026-09-23-swift-package-stack                                    | —       |
| docs/plans/2026-09-23-swiftui-app-stack         | change | SwiftUI app stack — the swiftui pack, Tuist, goldens, topics 1–11, the swift-swiftui bundle         | —           | 40       | APPROVED | 2026-09-23-swift-package-stack, 2026-09-23-swift-tasks-git-compat | —       |
