...
| `docs/plans/2026-09-20-init-mode-seam`        | change | init mode seam — three modes from evidence, the stack read, conflicts offered in every mode | —           | 20       | RUNNING  | 2026-09-20-pack-first-run-safety | B28      |
