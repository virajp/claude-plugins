...
| docs/plans/archived/2026-09-25-swift-gap-closure | change | Swift gap closure — the swift packs' and swiftui's open gaps, and doctor's folds                                  | —           | 10       | COMPLETE | —                                                                 | —       |
| docs/plans/2026-09-25-gate-hardening             | change | Gate hardening — the linter pinned and scoped, dprint's paths, a serial lint hook, a dprint-clean hygiene payload | —           | 20       | APPROVED | 2026-09-25-swift-gap-closure                                      | —       |
