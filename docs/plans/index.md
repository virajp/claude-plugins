...
| `docs/plans/2026-09-20-pack-intent-rendering` | change | pack intent rendering — conditional files, the editor split, one exclusion set            | —           | 50       | RUNNING  | 2026-09-20-branch-model          | B28      |
