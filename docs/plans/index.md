...
| docs/plans/2026-09-26-tool-config-mise                      | change | tool-config mise — a stackgen skill owns mise config; packs call it                       | —           | 30       | RUNNING  | 2026-09-26-mise-lock-sidecar-exclusions | B54, B66 (piece)         |
