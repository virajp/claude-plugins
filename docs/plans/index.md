...
| ---------------------------------------------- | ------ | -------------------------------------------------------------------- | ----------- | -------- | -------- | --------------------------------- | ------- |
| `docs/plans/2026-09-20-init-editor-dedupe`     | change | init editor dedupe — a hand key and the block never both carry a key | —           | 10       | RUNNING  | 2026-09-20-init-forge-pass        | B28     |
