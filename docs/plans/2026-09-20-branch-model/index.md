...
COMPLETE 2026-09-21 — 655a2219 7c126e56 ccbd1980 a0d3585c 455d8cc9 9972f25f
bfbd3aa9 1e321d27 ee88f359 66cd3073 7be02ec7 4423477f e85f2898 de488c14
fd7b8a55; folder left live — gap list open (R5 contested findings, late-run
GAPs)
...
| U6 | 3    | [06-docs.md](06-docs.md)                                 | edit   | `readme.md`, `CLAUDE.md`, `.claude/docs/**`, `.claude/skills/vwf-plugin/**`, `.claude/skills/stackgen-plugin/**`, `site/src/content/docs/**`, `docs/memory/decisions/2026-09-20-branch-model.md`                                                                                                                                             | R5             | green  | de488c14 |
| U7 | 4    | [07-gates-and-bump.md](07-gates-and-bump.md)             | edit   | `…/mise/pack.yaml`, `…/repo-hygiene/repo-hygiene/pack.yaml`, `plugins/stackgen/stacks/bundles/mise.md`, `bundles/repo-hygiene.md`, `plugins/stackgen/stacks/inventory.md`, the two `plugin.json`, `site/package.json`, `.claude-plugin/marketplace.json`                                                                                     | U6             | green  | fd7b8a55 |
...
| —    | reconcile               | —     | —     | skipped     | why: no covers: — no stamps, registry or environment; edit units only — nothing to persist beyond the Run log                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | —        |
| 3    | U6 docs                 | opus  | 1     | pass        | edit; 10 files: CLAUDE.md, ci-and-releases.md, vwf-plugin SKILL.md + skills-and-agents.md, site vwf.md, stackgen.md, single-repo.md, multi-repo.md, new decisions doc (mirrored to palace), Superseded-by line in the 2026-09-12 doc; DECIDED: readme.md and stackgen-plugin untouched (no false hit); CLAUDE.md notes this repo's own config is legacy until reshape; GAP: surveyor report reached the orchestrator, not the unit — survey redone by hand over the same inventory; formatter re-padded three run-log rows                                                                                                                                                                                                                                                                                                                           | de488c14 |
| 3    | R3                      | opus  | 1     | findings(1) | wave review; CONTRACT clean; RULINGS clean (spot-checked against landed wording); ci-and-releases.md:63-64 says every reader takes the legacy key "with a warning" — only the merge tasks warn                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | —        |
| 3    | U6 docs                 | opus  | 2     | pass        | edit (R3 loop-back); warning attributed to the merge tasks alone                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | de488c14 |
| 3    | R3                      | opus  | 2     | pass        | wave review; round-1 finding resolved; CONTRACT clean; RULINGS clean                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | —        |
| 4    | U7 gates-and-bump       | opus  | 1     | pass        | edit; mise 1.5.0, hygiene 1.1.4, vwf 19.41.0, stackgen 1.24.0, site 1.1.37; inventory and marketplace regenerated; all seven gate lines green; DECIDED: p:site:version refused the dirty tree (the orchestrator's uncommitted run-log edit) — its one write applied by hand to the value the task computes for patch; GAP: orchestrator's run-log edit was uncommitted when the unit ran — p:site:version must see a clean tree                                                                                                                                                                                                                                                                                                                                                                                                                      | fd7b8a55 |
| 4    | R4                      | opus  | 1     | pass        | wave review; nine owned files, version-only edits; pins, refs and inventory agree; no 13/17; CONTRACT clean; RULINGS clean                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | —        |
| —    | reconcile               | —     | —     | pass        | final wave gate over the finished tree: all seven lines green; orchestrator gates: none beyond the wave gate (per the plan)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | —        |
| —    | landing                 | —     | —     | pass        | Consent: merge yes; backlog: B53 → Done; B28 left In progress — plan 5 (pack-intent-rendering) still carries it and its Parked note said the id would need moving back by hand (DECIDED: not closed, per the repo's backlog rule); folder stays live with open gaps, not archived                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | —        |
