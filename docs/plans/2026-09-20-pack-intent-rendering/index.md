...
| -- | ---- | ---------------------------------------------------- | ------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------- | ------- | ------ |
| U1 | 1    | [01-pack-format.md](01-pack-format.md)               | edit   | `plugins/stackgen/assets/pack-format.md`, `plugins/stackgen/assets/output-tree.md`, `plugins/stackgen/skills/stackgen-stack-template/references/materializer.md`                                                                                                                                                                                                                                                                                                                                                 | —                      | green   |        |
| U2 | 1    | [02-checker.md](02-checker.md)                       | edit   | `scripts/src/check.ts`, `scripts/src/check.test.ts`, `.claude/skills/plugin-authoring/references/checks.md`                                                                                                                                                                                                                                                                                                                                                                                                      | —                      | green   |        |
| U3 | 1    | [03-hygiene-pack.md](03-hygiene-pack.md)             | edit   | `plugins/stackgen/stacks/repo-hygiene/repo-hygiene/**` except `pack.yaml`'s version line                                                                                                                                                                                                                                                                                                                                                                                                                         | —                      | green   |        |
| U4 | 1    | [04-stack-packs.md](04-stack-packs.md)               | edit   | `plugins/stackgen/stacks/toolchain-gate/{dprint,pre-commit,tsconfig,analysis-options}/**`, `plugins/stackgen/stacks/framework/astro/**`, `plugins/stackgen/stacks/package-manager/pnpm/**` — except each `pack.yaml`'s version line; widened at wave 1 (ruling 5a): `plugins/stackgen/stacks/toolchain-gate/gitleaks/config/.config/gitleaks.toml`                                                                                                                                                               | —                      | green   |        |
| U5 | 1    | [05-init.md](05-init.md)                             | edit   | `plugins/vwf/skills/init/SKILL.md`, `plugins/vwf/skills/init/references/new-repo.md`, `plugins/vwf/skills/init/references/fragments-and-sections.md`                                                                                                                                                                                                                                                                                                                                                             | —                      | green   |        |
| U6 | 1    | [06-doctor-and-bundles.md](06-doctor-and-bundles.md) | edit   | `plugins/vwf/skills/doctor/references/stack-checks.md`, `plugins/stackgen/stacks/bundles/repo-gates.md`                                                                                                                                                                                                                                                                                                                                                                                                          | —                      | green   |        |
...
| 1    | U4 stack packs        | opus  | 3     | pass        | edit, R1 loop-back; the four equality passages (dprint/conventions.md, taplo.toml, pre-commit-config.yaml, pre-commit/conventions.md) now state three-equal + gitleaks-subset with the widen rules; p:plugins:check green                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | —      |
| 1    | U5 init               | opus  | 3     | pass        | edit, R1 loop-back; SKILL.md four paragraphs and fragments-and-sections.md one paragraph reflowed to the 80-column fold, no wording change; new-repo.md scanned, untouched                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | —      |
