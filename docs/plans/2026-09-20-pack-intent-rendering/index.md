...
| U8 | 3    | [08-docs.md](08-docs.md)                             | edit   | `readme.md`, `CLAUDE.md`, `.claude/docs/**`, `.claude/skills/vwf-plugin/**`, `.claude/skills/stackgen-plugin/**`, `site/src/content/docs/**`, `docs/memory/decisions/2026-09-20-pack-intent-rendering.md`; widened at wave 1 (rule-5 findings in nobody-owned files): `plugins/stackgen/skills/stackgen-stack-template/SKILL.md` (the `repo:`/`answers:` caller line and Inputs), `plugins/vwf/skills/init/references/tool-configs.md:61-65`, `plugins/vwf/skills/init/references/readme-and-license.md:132-140` | R7                     | pending |          |
| U9 | 4    | [09-gates-and-bump.md](09-gates-and-bump.md)         | edit   | every `pack.yaml` version line named in decision 9 and, widened at wave 1 (ruling 5a), `toolchain-gate/gitleaks` `1.1.1` → `1.1.2`, `plugins/stackgen/stacks/bundles/*.md` pins, `plugins/stackgen/stacks/inventory.md`, the two `plugin.json`, `site/package.json`, `.claude-plugin/marketplace.json`                                                                                                                                                                                                           | U8                     | pending |          |
...
- **G-2 (wave 1, U1/U5, non-blocking)** — the plan names no caller for the
  answers on packs `setup`'s materialize pass lands (tsconfig, astro, pnpm
  fragments). Assumption: an omitted axis reads true and the path lands; init
  always passes every axis, `none` the explicit no-match value.
