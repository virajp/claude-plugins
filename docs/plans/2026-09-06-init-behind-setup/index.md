...
| U6 | 2    | [06-docs.md](06-docs.md)                         | `readme.md`, `CLAUDE.md`, `site/CLAUDE.md`, `site/src/content/docs/**`, `.claude/docs/**`, `.claude/skills/vwf-plugin/**`, `.claude/skills/stackgen-plugin/**`, `docs/memory/decisions/<run-date>-init-behind-setup.md`                      | U1–U5      | green   |            |
...
| 2    | docs-reconciler | opus  | 1     | findings(25) | written to `/tmp/init-behind-setup-reconciler.md` (site vwf.md ×10, stackgen.md ×2, readme.md, CLAUDE.md, vwf-plugin ×6, stackgen-plugin, repo-shape.md, how-to trio ×3); handed to U6 with the consolidated DOCS FALSIFIED list                                                                                                                                                                                                                                                                                                                                                                                                                                                              | —          |
| 2    | U6              | opus  | 1     | green        | 13 files (site vwf/stackgen/how-to ×3, readme, CLAUDE.md, vwf-plugin ×3, stackgen-plugin, repo-shape.md, new decisions doc). DECIDED: keep `/vwf:init` commands row marked Internal (table convention); fold single-repo init+setup into one setup step, retarget `#vwfinit` to the manual; drop reconciler's `plugins:check` sentence from the site manual; `/vwf:doctor` plain span (no anchor). GAP: fourth-row keys follow decision 1 not reconciler #16; `:936-937` says "stays model-invocable — and hidden" not "skill-invoked" (matches what landed); `.claude/docs/plugins.md` states no invocation state → unedited                                                                 | —          |
| 2    | R2              | opus  | 1     | findings(2)  | CONTRACT clean; RULINGS clean. vwf.md:843 "the second of them" ambiguous (ids is 2nd of six, 1st of the four); vwf-plugin SKILL.md:157 drops rule 4 from "rule 4 and `claude plugin validate` alone"                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | —          |
| 2    | U6              | opus  | 2     | green        | vwf.md preamble names both positions (first of the four, question 2 overall); vwf-plugin SKILL.md:157 → "rule 4 and `claude plugin validate` are all that check it"                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | —          |
