...
| U7 | 3    | [07-gates-and-bump.md](07-gates-and-bump.md)     | `plugins/vwf/.claude-plugin/plugin.json`, `plugins/stackgen/.claude-plugin/plugin.json`, `.claude-plugin/marketplace.json`, `plugins/stackgen/stacks/inventory.md`                                                                           | U6         | green  |            |
...
| 3    | U7              | opus  | 1     | green        | vwf 19.13.0 → 19.14.0, stackgen 1.2.0 → 1.2.1, marketplace.json regenerated (refs vwf-v19.14.0, stackgen-v1.2.1), inventory.md byte-identical; full gate + plan's 5 greps green                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | —          |
