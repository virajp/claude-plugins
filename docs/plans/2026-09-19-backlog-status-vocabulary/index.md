...
| U2 | 2    | [02-docs.md](02-docs.md)                     | edit | `.claude/skills/vwf-plugin/references/skills-and-agents.md`, `site/src/content/docs/plugins/vwf.md`, `docs/memory/decisions/2026-09-19-backlog-status-vocabulary.md`, `readme.md` | U1         | running |          |
...
| 1    | U1 skill  | opus  | 1     | pass    | edit; DECIDED: Status table cell shortened to fit the hand-aligned column; step 5 reads ids from field-list only (decision 4); GAP none                                                                                  | a609b8b8 |
| 1    | R1        | opus  | 1     | pass    | wave review: FINDINGS 0, CONTRACT clean, RULINGS clean; falsified passages all in U2's Owns                                                                                                                              | —        |
| 1    | gate      | —     | 1     | pass    | 5 gate lines green (precommit re-padded the folder's Run log once, green on the second pass)                                                                                                                             | a609b8b8 |
| 2    | U2 docs   | opus  | 1     | pass    | edit; docs-sync surveyor's 7 findings (all vwf.md) routed via the orchestrator, all applied; DECIDED: readme.md untouched (no finding); decision doc says next id is at least B12 (titles not read, no gh); GAP none     | —        |
