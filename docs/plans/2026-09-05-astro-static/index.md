...
**BLOCKED at wave 1 — U7 failed: orchestrator gate 12 (the shim), second cause;
U3, U4 skipped (depend on U7).** Worktree `.worktrees/2026-09-05-astro-static`
on branch `2026-09-05-astro-static`, cut from `develop` at `f6df9ed8`; started
2026-09-06. Nine wave-1 units are green and committed; U7's tree
(`plugins/stackgen/stacks/toolchain-gate/**`) sits uncommitted in the worktree,
reviewed clean and waiting on one ruling.

**Ruling needed (U7):** bare `dprint check`/`dprint fmt` through the root shim
exits 13 ("No formatting plugins found") because dprint 0.57.1 discovers the
dprint pack's editor fragment `.config/vscode.d/dprint.jsonc` — named
`<pack>.jsonc` by U5's convention (`pack-format.md`) — as a sub-directory
config. Choose one and paste it into `07-gate-packs.md`: (a) the dprint pack's
fragment is the one exception to `<pack>.jsonc` and ships as, e.g.,
`dprint-editor.jsonc` — the algorithm's `*.jsonc` glob still finds it, U5's
convention gains one sentence; or (b) the shipped `.config/dprint.json`
`excludes` `.config/vscode.d/`, so the fragments are never formatted by the gate
and discovery never reaches them; or (c) something else. Then re-run
...
| --- | ---- | ------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------- | ------- | ------ |
| U1  | 1    | [01-astro-pack.md](01-astro-pack.md)             | `plugins/stackgen/stacks/framework/astro/**`                                                                                                                                                                                                                                                                                                                                                                                            | —          | green   |        |
| U2  | 1    | [02-astro-bundles.md](02-astro-bundles.md)       | `plugins/stackgen/stacks/bundles/typescript-astro-react.md` (→ `astro-ssr.md`), `plugins/stackgen/stacks/bundles/astro-ssg.md`, `plugins/stackgen/stacks/bundles/astro-hybrid.md`, `plugins/stackgen/stacks/bundles/astro-csr.md`                                                                                                                                                                                                       | —          | green   |        |
| U5  | 1    | [05-ids-and-fence.md](05-ids-and-fence.md)       | `plugins/stackgen/assets/**`, `plugins/stackgen/skills/stackgen-stack-template/references/materializer.md`                                                                                                                                                                                                                                                                                                                              | —          | green   |        |
| U6  | 1    | [06-mise-pack.md](06-mise-pack.md)               | `plugins/stackgen/stacks/toolchain-manager/mise/**`                                                                                                                                                                                                                                                                                                                                                                                     | —          | green   |        |
| U7  | 1    | [07-gate-packs.md](07-gate-packs.md)             | `plugins/stackgen/stacks/toolchain-gate/**`                                                                                                                                                                                                                                                                                                                                                                                             | —          | failed  |        |
| U8  | 1    | [08-hygiene-and-pnpm.md](08-hygiene-and-pnpm.md) | `plugins/stackgen/stacks/repo-hygiene/**`, `plugins/stackgen/stacks/package-manager/pnpm/**`                                                                                                                                                                                                                                                                                                                                            | —          | green   |        |
| U9  | 1    | [09-init.md](09-init.md)                         | `plugins/vwf/skills/init/**`                                                                                                                                                                                                                                                                                                                                                                                                            | —          | green   |        |
| U10 | 1    | [10-doctor.md](10-doctor.md)                     | `plugins/vwf/skills/doctor/**`                                                                                                                                                                                                                                                                                                                                                                                                          | —          | green   |        |
| U11 | 1    | [11-checker.md](11-checker.md)                   | `scripts/src/**`                                                                                                                                                                                                                                                                                                                                                                                                                        | —          | green   |        |
| U12 | 1    | [12-workers-ssr.md](12-workers-ssr.md)           | `plugins/stackgen/stacks/cloud-service/workers-ssr/**`, `plugins/stackgen/stacks/bundles/cloudflare-workers-ssr.md`, `plugins/stackgen/stacks/bundles/cloudflare-zero-trust.md`, `plugins/stackgen/stacks/bundles/cloudflare-workers-static.md`, `plugins/stackgen/stacks/cloud-provider/cloudflare/**`, `plugins/stackgen/stacks/cloud-service/workers-static-assets/**`, `plugins/stackgen/stacks/cloud-service/zero-trust-access/**` | —          | green   |        |
| U3  | 2    | [03-docs.md](03-docs.md)                         | `readme.md`, `CLAUDE.md`, `site/CLAUDE.md`, `.claude/docs/**`, `.claude/skills/stackgen-plugin/**`, `.claude/skills/plugin-authoring/**`, `.claude/skills/vwf-plugin/**`, `site/src/content/docs/**`, `docs/memory/decisions/*`                                                                                                                                                                                                         | all        | skipped |        |
| U4  | 3    | [04-gates.md](04-gates.md)                       | `plugins/*/.claude-plugin/plugin.json`, `site/package.json`, `.claude-plugin/marketplace.json`, `plugins/stackgen/stacks/inventory.md`                                                                                                                                                                                                                                                                                                  | U3         | skipped |        |
...
| 1    | U6        | opus  | 2     | green       | `mise.toml` slug rule stated in place with the `virajp.dev` → `virajp-dev` example, names "stackgen's `assets/ids.md`" without a path token; `CLAUDE_PLUGIN_ROOT` absent from the pack's `config/`. `plugins:check`, `plugins:shellcheck` 0                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |        |
| 1    | U9        | opus  | 2     | green       | `existing-repo.md` pass 10 mirrors U7's shipped yaml: scopes re-run-only, forge links fill on any run with a remote (shipped commented out, filling = uncommenting); table gains a "Fillable" column. No sibling claim in `new-repo.md`; SKILL.md:172/:237 already correct                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |        |
