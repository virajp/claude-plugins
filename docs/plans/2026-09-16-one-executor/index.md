...
| -- | ---- | ---------------------------------------------------- | ---- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------- | ------- | ------ |
| U1 | 1    | [01-index-and-template.md](01-index-and-template.md) | edit | `plugins/vwf/assets/plan-index.md`, `plugins/vwf/assets/templates/plan-folder.md`, `plugins/vwf/assets/plan-interview.md`                                                | —          | pending |        |
| U3 | 1    | [03-execute-stages.md](03-execute-stages.md)         | edit | `plugins/vwf/assets/execute-stages.md`, `plugins/vwf/assets/memory.md`                                                                                                   | —          | pending |        |
| U2 | 2    | [02-execute.md](02-execute.md)                       | edit | `plugins/vwf/skills/execute/**`, `plugins/vwf/skills/change-execute/**` (delete)                                                                                         | U1, U3     | pending |        |
| U4 | 2    | [04-change-plan.md](04-change-plan.md)               | edit | `plugins/vwf/skills/change-plan/**`                                                                                                                                      | U1         | pending |        |
| U5 | 2    | [05-plan-and-consumers.md](05-plan-and-consumers.md) | edit | `plugins/vwf/skills/plan/**`, `plugins/vwf/skills/archive/**`, `plugins/vwf/skills/backlog/**`, `plugins/vwf/skills/feedback/SKILL.md`                                   | U1         | pending |        |
| U6 | 3    | [06-docs-repo.md](06-docs-repo.md)                   | edit | `readme.md`, `CLAUDE.md`, `.claude/skills/vwf-plugin/**`, `.claude/docs/**`, `.claude/skills/release/SKILL.md`, `docs/memory/decisions/2026-09-16-one-executor.md` (new) | U2, U4, U5 | pending |        |
| U7 | 3    | [07-docs-site.md](07-docs-site.md)                   | edit | `site/src/content/docs/**`                                                                                                                                               | U2, U4, U5 | pending |        |
