...
1.30.0 → 1.31.0"; "Release site publicly — patch — 1.1.43 → 1.1.44,
...
2. **stackgen** manifest by hand. If the tree reads a version other than 1.30.0,
...
`ops: stackgen 1.31.0, site 1.1.44 — SwiftUI app stack`
