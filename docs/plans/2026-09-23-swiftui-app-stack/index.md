...
| U8  | 3    | [08-swiftui-topics-xcode.md](08-swiftui-topics-xcode.md) | edit   | `plugins/stackgen/stacks/app-framework/swiftui/skills/swiftui/references/*.md` (the eleven topic files, top level only)                                                                                                                                                                                                          | —                         | green   |          |
| U9  | 3    | [09-bundle-xcode.md](09-bundle-xcode.md)                 | edit   | `plugins/stackgen/stacks/bundles/swift-swiftui.md`                                                                                                                                                                                                                                                                               | —                         | green   |          |
| U10 | 3    | [10-init-stack-read.md](10-init-stack-read.md)           | edit   | `plugins/vwf/skills/init/SKILL.md`                                                                                                                                                                                                                                                                                               | —                         | green   |          |
| U11 | 3    | [11-repo-hygiene.md](11-repo-hygiene.md)                 | edit   | `plugins/stackgen/stacks/repo-hygiene/repo-hygiene/conventions.md`, `plugins/stackgen/stacks/repo-hygiene/repo-hygiene/pack.yaml`, `plugins/stackgen/stacks/bundles/repo-hygiene.md`                                                                                                                                             | —                         | green   |          |
