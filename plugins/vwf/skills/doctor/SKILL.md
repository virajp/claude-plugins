...
or empty `MEMBERS` under siblings linkage. Each row is printed under the repo
it was found in, and an **absent** member is a blind spot rather than a row. A
repo behind its baseline still works, so none of those is ever blocking),
