...
owes is stackgen's neutral object-storage contract, clause by clause. The
contract states what **any** object store must satisfy; this file states
how this one does, **citing rather than restating**.
